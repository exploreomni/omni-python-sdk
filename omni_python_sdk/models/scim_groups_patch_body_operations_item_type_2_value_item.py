...
T = TypeVar("T", bound="ScimGroupsPatchBodyOperationsItemType2ValueItem")


@_attrs_define
class ScimGroupsPatchBodyOperationsItemType2ValueItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_groups_patch_body_operations_item_type_2_value_item = cls(
            value=value,
            display=display,
        )

        scim_groups_patch_body_operations_item_type_2_value_item.additional_properties = d
