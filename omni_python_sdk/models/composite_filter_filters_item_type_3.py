...
from ..models.composite_filter_filters_item_type_3_type import (
    CompositeFilterFiltersItemType3Type,
    check_composite_filter_filters_item_type_3_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompositeFilterFiltersItemType3")


@_attrs_define
class CompositeFilterFiltersItemType3:
    """
    Attributes:
        type_ (CompositeFilterFiltersItemType3Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = check_composite_filter_filters_item_type_3_type(d.pop("type"))
        ...
        composite_filter_filters_item_type_3 = cls(
            type_=type_,
        ...
        composite_filter_filters_item_type_3.additional_properties = d
