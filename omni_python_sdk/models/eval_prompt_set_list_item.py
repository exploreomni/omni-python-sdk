...
T = TypeVar("T", bound="EvalPromptSetListItem")


@_attrs_define
class EvalPromptSetListItem:
    """
    Attributes:
        ...
        latest_run_at (None | str): ISO 8601 timestamp of the most recent run on this prompt set, if any. Example:
            2025-01-15T10:05:00.000Z.
        prompt_count (int): Number of prompts in the set. Example: 12.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_latest_run_at(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        latest_run_at = _parse_latest_run_at(d.pop("latest_run_at"))

        prompt_count = d.pop("prompt_count")

        eval_prompt_set_list_item = cls(
            created_at=created_at,
            description=description,
            id=id,
            is_archived=is_archived,
        ...
        eval_prompt_set_list_item.additional_properties = d
        return eval_prompt_set_list_item
