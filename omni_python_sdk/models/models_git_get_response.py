...
from ..models.models_git_get_response_auth_method import (
    ModelsGitGetResponseAuthMethod,
    check_models_git_get_response_auth_method,
)
from ..models.models_git_get_response_require_pull_request import (
    ModelsGitGetResponseRequirePullRequest,
    check_models_git_get_response_require_pull_request,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsGitGetResponse")


@_attrs_define
class ModelsGitGetResponse:
    """
    Attributes:
        ...
        public_key (None | str): SSH public key for repository access (deploy key). Null for HTTPS token auth. Example:
            ssh-ed25519 AAAA....
        require_pull_request (ModelsGitGetResponseRequirePullRequest): When pull requests are required: "always" for all
            changes, "users-only" for user-initiated changes only, "never" for direct commits. Example: users-only.
    ...
    auth_method: ModelsGitGetResponseAuthMethod
    base_branch: str
    ...
    model_path: None | str
    public_key: None | str
    require_pull_request: ModelsGitGetResponseRequirePullRequest
    ssh_url: str
    web_url: None | str
    webhook_url: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        auth_method = check_models_git_get_response_auth_method(d.pop("authMethod"))
        ...
        require_pull_request = check_models_git_get_response_require_pull_request(d.pop("requirePullRequest"))
        ...
        models_git_get_response.additional_properties = d
        return models_git_get_response
