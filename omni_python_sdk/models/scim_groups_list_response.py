...
T = TypeVar("T", bound="ScimGroupsListResponse")
...
class ScimGroupsListResponse:
    """
    Attributes:
        resources (list[ScimGroupResponse]): List of SCIM groups
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ScimGroupResponse.from_dict(resources_item_data)
        ...
        return scim_groups_list_response
