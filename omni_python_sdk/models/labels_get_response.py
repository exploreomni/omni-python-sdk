...
T = TypeVar("T", bound="LabelsGetResponse")


@_attrs_define
class LabelsGetResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        labels_get_response.additional_properties = d
        return labels_get_response
