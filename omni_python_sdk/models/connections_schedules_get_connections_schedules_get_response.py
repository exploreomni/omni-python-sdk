...
T = TypeVar("T", bound="ConnectionsSchedulesGetConnectionsSchedulesGetResponse")


@_attrs_define
class ConnectionsSchedulesGetConnectionsSchedulesGetResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connections_schedules_get_connections_schedules_get_response = cls(
        ...
        connections_schedules_get_connections_schedules_get_response.additional_properties = d
