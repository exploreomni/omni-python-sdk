...
from ..models.documents_put_query_presentation_chart_type_type_1 import (
    DocumentsPutQueryPresentationChartTypeType1,
    check_documents_put_query_presentation_chart_type_type_1,
)
from ..models.documents_put_query_presentation_chart_type_type_2_type_1 import (
    DocumentsPutQueryPresentationChartTypeType2Type1,
    check_documents_put_query_presentation_chart_type_type_2_type_1,
)
from ..models.documents_put_query_presentation_chart_type_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.documents_put_query_presentation_ai_config import DocumentsPutQueryPresentationAiConfig


T = TypeVar("T", bound="DocumentsPutQueryPresentation")


@_attrs_define
class DocumentsPutQueryPresentation:
    """
    Attributes:
        name (str): Query presentation name
        ai_config (DocumentsPutQueryPresentationAiConfig | Unset): AI configuration
        chart_type (DocumentsPutQueryPresentationChartTypeType1 | DocumentsPutQueryPresentationChartTypeType2Type1 |
            DocumentsPutQueryPresentationChartTypeType3Type1 | None | Unset): Chart type
        description (str | Unset): Description
        prefers_chart (bool | Unset): Whether to prefer chart view
        query (Any | Unset): Query definition
        query_identifier_map_key (str | Unset): Round-trip preservation hint. When the value matches an existing key on
            the document, the tile keeps its map key (and dashboard containers stay attached). Omit for new tiles. Must be a
            positive integer string (e.g. "1", "2", "10").
        result_config (Any | Unset): Result config
    ...
    name: str
    ai_config: DocumentsPutQueryPresentationAiConfig | Unset = UNSET
    chart_type: (
        DocumentsPutQueryPresentationChartTypeType1
        | DocumentsPutQueryPresentationChartTypeType2Type1
        | DocumentsPutQueryPresentationChartTypeType3Type1
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        ai_config: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _ai_config = d.pop("aiConfig", UNSET)
        ai_config: DocumentsPutQueryPresentationAiConfig | Unset
        if isinstance(_ai_config, Unset):
            ai_config = UNSET
        else:
            ai_config = DocumentsPutQueryPresentationAiConfig.from_dict(_ai_config)
        ...
        def _parse_chart_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                chart_type_type_1 = check_documents_put_query_presentation_chart_type_type_1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                chart_type_type_2_type_1 = check_documents_put_query_presentation_chart_type_type_2_type_1(data)

                return chart_type_type_2_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, str):
                    raise TypeError()
                chart_type_type_3_type_1 = check_documents_put_query_presentation_chart_type_type_3_type_1(data)

                return chart_type_type_3_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(
                DocumentsPutQueryPresentationChartTypeType1
        ...
        documents_put_query_presentation = cls(
            name=name,
            ai_config=ai_config,
        ...
        documents_put_query_presentation.additional_properties = d
        return documents_put_query_presentation
