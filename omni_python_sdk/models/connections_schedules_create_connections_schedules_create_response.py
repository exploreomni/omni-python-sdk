...
T = TypeVar("T", bound="ConnectionsSchedulesCreateConnectionsSchedulesCreateResponse")


@_attrs_define
class ConnectionsSchedulesCreateConnectionsSchedulesCreateResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connections_schedules_create_connections_schedules_create_response = cls(
        ...
        connections_schedules_create_connections_schedules_create_response.additional_properties = d
        return connections_schedules_create_connections_schedules_create_response
