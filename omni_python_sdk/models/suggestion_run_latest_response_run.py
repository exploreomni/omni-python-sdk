...
T = TypeVar("T", bound="SuggestionRunLatestResponseRun")


@_attrs_define
class SuggestionRunLatestResponseRun:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suggestion_run_latest_response_run = cls(
        ...
        suggestion_run_latest_response_run.additional_properties = d
        return suggestion_run_latest_response_run
