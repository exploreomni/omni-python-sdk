...
T = TypeVar("T", bound="ConnectionsSchedulesUpdateConnectionsSchedulesUpdateResponse")


@_attrs_define
class ConnectionsSchedulesUpdateConnectionsSchedulesUpdateResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connections_schedules_update_connections_schedules_update_response = cls(
        ...
        connections_schedules_update_connections_schedules_update_response.additional_properties = d
