...
from ..models.folders_add_permissions_body_role import (
    FoldersAddPermissionsBodyRole,
    check_folders_add_permissions_body_role,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FoldersAddPermissionsBody")


@_attrs_define
class FoldersAddPermissionsBody:
    """
    Attributes:
        role (FoldersAddPermissionsBodyRole): Content role to assign (VIEWER, EDITOR, or MANAGER) Example: VIEWER.
        access_boost (bool | Unset): Whether to grant access boost Default: False.
        user_group_ids (list[str] | Unset): User group IDs to grant permission to
        user_ids (list[UUID] | Unset): User IDs to grant permission to
    """

    role: FoldersAddPermissionsBodyRole
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        role = check_folders_add_permissions_body_role(d.pop("role"))
        ...
        folders_add_permissions_body = cls(
            role=role,
        ...
        return folders_add_permissions_body
