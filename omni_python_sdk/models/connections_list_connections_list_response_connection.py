...
from ..models.connections_list_connections_list_response_connection_dialect import (
    ConnectionsListConnectionsListResponseConnectionDialect,
    check_connections_list_connections_list_response_connection_dialect,
)

T = TypeVar("T", bound="ConnectionsListConnectionsListResponseConnection")


@_attrs_define
class ConnectionsListConnectionsListResponseConnection:
    """Connection object
    ...
    Attributes:
        ...
        dialect (ConnectionsListConnectionsListResponseConnectionDialect): Database dialect type Example: snowflake.
    ...
    deleted_at: None | str
    dialect: ConnectionsListConnectionsListResponseConnectionDialect
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dialect = check_connections_list_connections_list_response_connection_dialect(d.pop("dialect"))
        ...
        connections_list_connections_list_response_connection = cls(
        ...
        connections_list_connections_list_response_connection.additional_properties = d
        return connections_list_connections_list_response_connection
