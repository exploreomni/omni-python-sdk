...
from ..models.eval_run_list_item_status import EvalRunListItemStatus, check_eval_run_list_item_status

if TYPE_CHECKING:
    from ..models.eval_run_stats import EvalRunStats


T = TypeVar("T", bound="EvalRunListItem")


@_attrs_define
class EvalRunListItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = check_eval_run_list_item_status(d.pop("status"))

        eval_run_list_item = cls(
            branch_id=branch_id,
            branch_name=branch_name,
            completed_at=completed_at,
            created_at=created_at,
        ...
        eval_run_list_item.additional_properties = d
        return eval_run_list_item
