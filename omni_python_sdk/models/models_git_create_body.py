...
from ..models.models_git_create_body_auth_method import (
    ModelsGitCreateBodyAuthMethod,
    check_models_git_create_body_auth_method,
)
from ..models.models_git_create_body_git_service_provider import (
    ModelsGitCreateBodyGitServiceProvider,
    check_models_git_create_body_git_service_provider,
)
from ..models.models_git_create_body_require_pull_request import (
    ModelsGitCreateBodyRequirePullRequest,
    check_models_git_create_body_require_pull_request,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsGitCreateBody")


@_attrs_define
class ModelsGitCreateBody:
    """
    Attributes:
        auth_method (ModelsGitCreateBodyAuthMethod | Unset): Authentication method. "ssh" for deploy key (default),
            "https_token" for deploy token/PAT. Default: 'ssh'. Example: ssh.
        base_branch (str | Unset): The target branch for Omni pull requests. Defaults to "main" Default: 'main'.
            Example: main.
        branch_per_pull_request (bool | Unset): If true, all pull requests will create a branch in Omni. Defaults to
            false Default: False.
        ...
        model_path (str | Unset): Path to model files in the repository. Defaults to omni/<model-name>. Use a plain name
            (e.g., "my_model") for omni/my_model, or a leading slash for a custom path (e.g., "/bi/models/sales") Example:
            my_model.
        require_pull_request (ModelsGitCreateBodyRequirePullRequest | Unset): Controls when pull requests are required.
            Defaults to "never" Default: 'never'. Example: never.
        ssh_url (str | Unset): Deprecated — use cloneUrl. Clone URL of the git repository. Example:
            git@github.com:org/repo.git.
        token (str | Unset): HTTPS token for authentication (deploy token value, PAT, etc.). Required when authMethod is
            "https_token".
    ...
    auth_method: ModelsGitCreateBodyAuthMethod | Unset = "ssh"
    ...
    require_pull_request: ModelsGitCreateBodyRequirePullRequest | Unset = "never"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_method: ModelsGitCreateBodyAuthMethod | Unset
        if isinstance(_auth_method, Unset):
            auth_method = UNSET
        else:
            auth_method = check_models_git_create_body_auth_method(_auth_method)
        ...
        git_service_provider: ModelsGitCreateBodyGitServiceProvider | Unset
        if isinstance(_git_service_provider, Unset):
            git_service_provider = UNSET
        else:
            git_service_provider = check_models_git_create_body_git_service_provider(_git_service_provider)

        model_path = d.pop("modelPath", UNSET)

        _require_pull_request = d.pop("requirePullRequest", UNSET)
        require_pull_request: ModelsGitCreateBodyRequirePullRequest | Unset
        if isinstance(_require_pull_request, Unset):
            require_pull_request = UNSET
        else:
            require_pull_request = check_models_git_create_body_require_pull_request(_require_pull_request)
        ...
        models_git_create_body.additional_properties = d
        return models_git_create_body
