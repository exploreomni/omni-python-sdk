...
T = TypeVar("T", bound="SettingsReadExternalCustomTextType0")


@_attrs_define
class SettingsReadExternalCustomTextType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        settings_read_external_custom_text_type_0 = cls(
            query_error=query_error,
            query_no_results=query_no_results,
        )

        settings_read_external_custom_text_type_0.additional_properties = d
        return settings_read_external_custom_text_type_0
