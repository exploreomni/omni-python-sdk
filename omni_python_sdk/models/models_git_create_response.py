...
from ..models.models_git_create_response_auth_method import (
    ModelsGitCreateResponseAuthMethod,
    check_models_git_create_response_auth_method,
)
from ..models.models_git_create_response_require_pull_request import (
    ModelsGitCreateResponseRequirePullRequest,
    check_models_git_create_response_require_pull_request,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsGitCreateResponse")


@_attrs_define
class ModelsGitCreateResponse:
    """
    Attributes:
        auth_method (ModelsGitCreateResponseAuthMethod): Authentication method. "ssh" for deploy key, "https_token" for
        ...
        public_key (None | str): SSH public key for repository access (deploy key). Null for HTTPS token auth. Example:
            ssh-ed25519 AAAA....
        require_pull_request (ModelsGitCreateResponseRequirePullRequest): When pull requests are required: "always" for
    ...
    auth_method: ModelsGitCreateResponseAuthMethod
    base_branch: str
    ...
    model_path: None | str
    public_key: None | str
    require_pull_request: ModelsGitCreateResponseRequirePullRequest
    ssh_url: str
    web_url: None | str
    webhook_url: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        auth_method = check_models_git_create_response_auth_method(d.pop("authMethod"))
        ...
        require_pull_request = check_models_git_create_response_require_pull_request(d.pop("requirePullRequest"))
        ...
        models_git_create_response = cls(
        ...
        models_git_create_response.additional_properties = d
