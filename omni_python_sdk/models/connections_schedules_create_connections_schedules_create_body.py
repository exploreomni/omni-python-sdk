...
T = TypeVar("T", bound="ConnectionsSchedulesCreateConnectionsSchedulesCreateBody")


@_attrs_define
class ConnectionsSchedulesCreateConnectionsSchedulesCreateBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connections_schedules_create_connections_schedules_create_body = cls(
            schedule=schedule,
            timezone=timezone,
