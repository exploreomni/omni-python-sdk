...
T = TypeVar("T", bound="UsersAssignModelRoleBody")


@_attrs_define
class UsersAssignModelRoleBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_assign_model_role_body = cls(
            role_name=role_name,
            connection_id=connection_id,
            model_id=model_id,
        )

        users_assign_model_role_body.additional_properties = d
        return users_assign_model_role_body
