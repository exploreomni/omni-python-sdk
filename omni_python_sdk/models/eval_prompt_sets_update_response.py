...
T = TypeVar("T", bound="EvalPromptSetsUpdateResponse")


@_attrs_define
class EvalPromptSetsUpdateResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        eval_prompt_sets_update_response = cls(
            prompt_set=prompt_set,
        )

        eval_prompt_sets_update_response.additional_properties = d
