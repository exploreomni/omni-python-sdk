...
from ...models.eval_prompt_sets_get_response import EvalPromptSetsGetResponse
...
) -> EvalApiError400 | EvalApiError401 | EvalApiError403 | EvalApiError404 | EvalPromptSetsGetResponse | None:
    if response.status_code == 200:
        response_200 = EvalPromptSetsGetResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EvalApiError400 | EvalApiError401 | EvalApiError403 | EvalApiError404 | EvalPromptSetsGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EvalApiError400 | EvalApiError401 | EvalApiError403 | EvalApiError404 | EvalPromptSetsGetResponse
    """
