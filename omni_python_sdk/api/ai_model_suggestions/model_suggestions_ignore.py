...
from ...models.ignore_suggestion_body import IgnoreSuggestionBody
...
def _get_kwargs(
    ...
    suggestion_id: UUID,
    *,
    body: IgnoreSuggestionBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/models/{model_id}/suggestions/{suggestion_id}/ignore".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (IgnoreSuggestionBody | Unset):
