...
from ...models.connections_get_connections_get_response import ConnectionsGetConnectionsGetResponse
...
) -> Any | ConnectionsGetConnectionsGetResponse | None:
    if response.status_code == 200:
        response_200 = ConnectionsGetConnectionsGetResponse.from_dict(response.json())
