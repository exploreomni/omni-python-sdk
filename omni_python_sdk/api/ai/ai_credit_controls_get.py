...
) -> AiCreditControlsResponse | ApiError401 | ApiError403 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AiCreditControlsResponse | ApiError401 | ApiError403]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        AiCreditControlsResponse | ApiError401 | ApiError403
    """
