...
from ...models.users_get_model_roles_response import UsersGetModelRolesResponse
...
) -> Any | UsersGetModelRolesResponse | None:
    if response.status_code == 200:
        response_200 = UsersGetModelRolesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | UsersGetModelRolesResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | UsersGetModelRolesResponse
    """
