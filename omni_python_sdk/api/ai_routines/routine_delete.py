...
from ...models.routine_delete_response import RoutineDeleteResponse
...
) -> ApiError400 | ApiError401 | ApiError403 | ApiError404 | RoutineDeleteResponse | None:
    if response.status_code == 200:
        response_200 = RoutineDeleteResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiError400 | ApiError401 | ApiError403 | ApiError404 | RoutineDeleteResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiError400 | ApiError401 | ApiError403 | ApiError404 | RoutineDeleteResponse
    """
