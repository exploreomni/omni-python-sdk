...
from ...models.routine_trigger_response import RoutineTriggerResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/ai/routines/{id}/trigger".format(
...
) -> ApiError400 | ApiError401 | ApiError403 | ApiError404 | ApiError409 | RoutineTriggerResponse | None:
    if response.status_code == 202:
        response_202 = RoutineTriggerResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiError400 | ApiError401 | ApiError403 | ApiError404 | ApiError409 | RoutineTriggerResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiError400 | ApiError401 | ApiError403 | ApiError404 | ApiError409 | RoutineTriggerResponse
    """
