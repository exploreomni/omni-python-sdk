...
from ...models.documents_update_permits_body import DocumentsUpdatePermitsBody
...
def _get_kwargs(
    identifier: str,
    *,
    body: DocumentsUpdatePermitsBody | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *,
    ...
    Args:
        identifier (str): Document identifier (either document ID or identifier slug) Example:
            abc123.
        body (DocumentsUpdatePermitsBody | Unset):
