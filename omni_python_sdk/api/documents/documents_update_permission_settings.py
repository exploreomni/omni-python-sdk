...
from ...models.documents_update_permission_settings_body import DocumentsUpdatePermissionSettingsBody
...
def _get_kwargs(
    identifier: str,
    *,
    body: DocumentsUpdatePermissionSettingsBody | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *,
    ...
    Args:
        identifier (str): Document identifier (either document ID or identifier slug) Example:
            abc123.
        body (DocumentsUpdatePermissionSettingsBody | Unset):
