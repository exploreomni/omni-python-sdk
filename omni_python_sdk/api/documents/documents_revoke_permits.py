...
from ...models.documents_revoke_permits_body import DocumentsRevokePermitsBody
...
def _get_kwargs(
    identifier: str,
    *,
    body: DocumentsRevokePermitsBody | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *,
    ...
    Args:
        identifier (str): Document identifier (either document ID or identifier slug) Example:
            abc123.
        body (DocumentsRevokePermitsBody | Unset):
