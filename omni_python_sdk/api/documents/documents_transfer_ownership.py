...
from ...models.documents_transfer_ownership_body import DocumentsTransferOwnershipBody
...
def _get_kwargs(
    identifier: str,
    *,
    body: DocumentsTransferOwnershipBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/documents/{identifier}/transfer-ownership".format(
    ...
    *,
    ...
    Args:
        identifier (str): Document identifier (either document ID or identifier slug) Example:
            abc123.
        body (DocumentsTransferOwnershipBody | Unset):
