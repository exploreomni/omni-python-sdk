...
from ...models.models_get_view_response import ModelsGetViewResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/models/{model_id}/view".format(
...
) -> Any | ModelsGetViewResponse | None:
    if response.status_code == 200:
        response_200 = ModelsGetViewResponse.from_dict(response.json())
