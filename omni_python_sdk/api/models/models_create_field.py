...
from ...models.models_create_field_body import ModelsCreateFieldBody
...
def _get_kwargs(
    model_id: UUID,
    *,
    body: ModelsCreateFieldBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/models/{model_id}/field".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ModelsCreateFieldBody | Unset):
