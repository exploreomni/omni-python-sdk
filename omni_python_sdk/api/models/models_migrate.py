...
from ...models.models_migrate_body import ModelsMigrateBody
...
def _get_kwargs(
    model_id: UUID,
    *,
    body: ModelsMigrateBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/models/{model_id}/migrate".format(
