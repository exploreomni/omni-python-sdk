...
from ...models.models_list_topics_response import ModelsListTopicsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/models/{model_id}/topic".format(
...
) -> Any | ModelsListTopicsResponse | None:
    if response.status_code == 200:
        response_200 = ModelsListTopicsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ModelsListTopicsResponse]:
    return Response(
