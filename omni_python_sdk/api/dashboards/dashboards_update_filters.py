...
from ...models.dashboards_update_filters_body import DashboardsUpdateFiltersBody
...
def _get_kwargs(
    identifier: str,
    *,
    body: DashboardsUpdateFiltersBody | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DashboardsUpdateFiltersBody | Unset):
