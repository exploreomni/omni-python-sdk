...
from ...models.schedules_recipients_get_response import SchedulesRecipientsGetResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/schedules/{schedule_id}/recipients".format(
...
) -> Any | SchedulesRecipientsGetResponse | None:
    if response.status_code == 200:
        response_200 = SchedulesRecipientsGetResponse.from_dict(response.json())
