...
from ...models.schedules_transfer_ownership_body import SchedulesTransferOwnershipBody
...
def _get_kwargs(
    schedule_id: UUID,
    *,
    body: SchedulesTransferOwnershipBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/schedules/{schedule_id}/transfer-ownership".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (SchedulesTransferOwnershipBody | Unset):
